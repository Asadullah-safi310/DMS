...
function Banner() {
  ...
  return (
    <div className='flex items-center justify-center   bg-[var(--primary-color)] rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
        ...
        <div className=' hidden md:block md:w-1/2 lg:w-[370px]'>
            <img className='w-full  max-w-md' src={assets.appointment_img} alt="" />
        </div>
    </div>
  )
}
